package ru.aykozhaevnm.loggingstarter.aspect;
...
import ru.aykozhaevnm.loggingstarter.annotation.LogExecutionTime;
...
public class LogExecutionAspect {
    ...
    @Around("@annotation(ru.aykozhaevnm.loggingstarter.annotation.LogExecutionTime)")
